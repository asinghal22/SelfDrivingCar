...
#cv2.drawContours(line_image,left_lines,0,(0,255,0),3)

for indx in range (1,50):
    cv2.line(line_image,left_lines[indx-1], left_lines[indx],[255,0,0],8)
    cv2.line(line_image,right_lines[indx-1],right_lines[indx],[255,0,0],8)
